...
const newContent = `# BẢN ĐỀ XUẤT GIẢI PHÁP & BẢNG BÁO GIÁ CHI TIẾT THƯƠNG HIỆU HUCE
...
## I. GÓI TỔNG THỂ: CHUẨN HÓA HỆ THỐNG THƯƠNG HIỆU & VẬN HÀNH TRUYỀN THÔNG ĐỒNG HÀNH (800.000.000 VND)
...
## II. MENU DỊCH VỤ TRUYỀN THÔNG SỰ KIỆN GIA TĂNG (ON-DEMAND / BOOK-BY-EVENT MENU)
...
1.  **Thanh toán theo phân đoạn:** Hai bên ký kết và nghiệm thu thanh toán theo từng giai đoạn độc lập của từng gói. Khi hoàn thành cấu phần A, ConsMedia đóng gói và chuyển giao toàn bộ tài sản thiết kế để nhà trường chủ động đưa vào sử dụng và triển khai bảo hộ pháp lý ngay.
...
console.log('Successfully rewrote 03_bao_gia_va_specs_chi_tiet.md');
