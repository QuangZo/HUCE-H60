...
const workspacePath = path.join(__dirname, '..', 'walkthrough.md');
const brainPath = 'C:\\Users\\Admin\\.gemini\\antigravity\\brain\\a5bb0902-08f9-4c1c-a377-7c5160196c76\\walkthrough.md';

const newWalkthrough = `# Báo cáo Nghiệm thu Hoàn thành: Xây dựng & Tái cấu trúc Hệ thống Tài liệu Thương hiệu HUCE
...
fs.writeFileSync(workspacePath, newWalkthrough, 'utf8');
console.log('Updated walkthrough.md in workspace.');

if (fs.existsSync(path.dirname(brainPath))) {
    fs.writeFileSync(brainPath, newWalkthrough, 'utf8');
    console.log('Updated walkthrough.md in brain directory.');
} else {
    console.log('Warning: Brain path directory does not exist.');
}
